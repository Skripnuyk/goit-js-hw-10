export function countryCardTemplate({ name, capital, flags, population, languages }) {
    ...
    <p class="country-info__capital"><span class="country-info__weight">Population:</span>${population}</p>
    <p class="country-info__capital"><span class="country-info__weight">Languages:</span>${Object.values(languages)}</p>
    </div>`;
}
